...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " generalcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  generalcoin-tx [options] <hex-tx> [commands]  Update hex-encoded generalcoin transaction\n" +
            "or:     generalcoin-tx [options] -create [commands]   Create hex-encoded generalcoin transaction\n" +
            "\n";
