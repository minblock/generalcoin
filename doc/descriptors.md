# Support for Output Descriptors in Generalcoin Core

Since Generalcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Generalcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Generalcoin Core wallets, a convenience function `combo` is
