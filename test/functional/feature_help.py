...
"""Verify that starting generalcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start generalcoin with -h for help text")
        ...
        self.log.info("Start generalcoin with -version for version information")
        ...
        self.log.info("Start generalcoind with -fakearg to make sure it does not start")
